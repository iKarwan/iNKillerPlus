...
* **Sideloading || TrollStore (No Jailbreak):**
    ...
    1. Download IPA file from here and follow the instructions below to sign and install the app from your computer for one week
        ...
        | ------------------ |:---------:|:------:|:------:|:------:|
        | [Instagram](https://ikghd.site/ipaa/Instagram_293.1_iNKillerPlus_2.1.14.ipa) | com.burbn.instagram | 293.1 | 2.1.14 | IPA |
        | [TrollStore](https://ikghd.site/ipaa/Instagram_293.1_iNKillerPlus_2.1.14_TrollStore.ipa) | com.burbn.instagram | 293.1 | 2.1.14 | IPA |
...
* Right click on the AltServer icon with your phone connected and choose "Install Altstore", then the name of your phone. When prompted sign in with your Apple ID. Two-factor Authentication is supported, app-specific passwords are not.
    ...
    * [Open In AltStore iNKillerPlus v293.1](https://tinyurl.com/) this will take some time as it altstore need to download the iPA and it depending on the internet connection speed .
...
* download the Instagram ipa from the link [here](https://ikghd.site/ipaa/Instagram_293.1_iNKillerPlus_2.1.14_TrollStore.ipa) and install it via TrollStore:
