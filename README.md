...
* **Sideloading || TrollStore (No Jailbreak):**
    ...
    1. Download IPA file from here and follow the instructions below to sign and install the app from your computer for one week
        ...
        | ------------------ |:---------:|:------:|:------:|:------:|
        | [Instagram](https://ikghd.site/ipa/Instagram_409.1_iNKillerPlus_3.1.0.ipa) | com.burbn.instagram | 409.1 | 3.1.0 | IPA |
        | [TrollStore](https://ikghd.site/ipa/Instagram_409.1_iNKillerPlus_3.1.0_TrollStore.tipa) | com.burbn.instagram | 409.1 | 3.1.0 | tipa |
...
* Copy this link [here](https://ikghd.site/ipa/Instagram_409.1_iNKillerPlus_3.1.0_TrollStore.tipa) and paste it into the "Install from URL" option in TrollStore.
