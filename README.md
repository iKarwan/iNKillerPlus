...
* **Sideloading || TrollStore (No Jailbreak):**
    ...
    1. Download IPA file from here and follow the instructions below to sign and install the app from your computer for one week
        ...
        | ------------------ |:---------:|:------:|:------:|:------:|
        | [Instagram](https://ikghd.site/ipaa/Instagram_295.0_iNKillerPlus_2.2.ipa) | com.burbn.instagram | 295.0 | 2.2 | IPA |
        | [TrollStore](https://ikghd.site/ipaa/Instagram_295.0_iNKillerPlus_2.2_TrollStore.ipa) | com.burbn.instagram | 295.0 | 2.2 | IPA |
...
* Right click on the AltServer icon with your phone connected and choose "Install Altstore", then the name of your phone. When prompted sign in with your Apple ID. Two-factor Authentication is supported, app-specific passwords are not.
    ...
    * [Open In AltStore iNKillerPlus v295.0](https://tinyurl.com/) this will take some time as it altstore need to download the iPA and it depending on the internet connection speed .
...
* download the Instagram ipa from the link [here](https://ikghd.site/ipaa/Instagram_295.0_iNKillerPlus_2.2_TrollStore.ipa) and install it via TrollStore:
